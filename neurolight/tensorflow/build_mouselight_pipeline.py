...
def train(n_iterations, setup_config, mknet_tensor_names, loss_tensor_names):
    ...
    data_sources = tuple(
        ...
        + gp.RandomLocation(
            ...
            point_balance_radius=70 * micron_scale,
        )
        + TopologicalMatcher(
            skeletonization,
            consensus,
            ...
            match_distance_threshold=7.6 * micron_scale,
            max_gap_crossing=4.8 * micron_scale,
            try_complete=False,
            use_gurobi=True,
        )
        + RasterizeSkeleton(
        ...
        + GrowLabels(labels, radii=[3 * micron_scale])
    ...
    pipeline = (
        ...
        + FusionAugment(
            ...
            blend_smoothness=10 * micron_scale,
