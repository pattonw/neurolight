...
class ConsensusMatchTest(unittest.TestCase):
    ...
    def test_simple_4_way(self):
        ...
        self.assertEqual(skeleton.edges[('a', 'b')]['matched_edge'] == ('A', ('X', 'A')))
        self.assertEqual(skeleton.edges[('c', 'd')]['matched_edge'] == ('D', ('X', 'D')))
        self.assertEqual(skeleton.edges[('f', 'g')]['matched_edge'] == ('B', ('X', 'B')))
        self.assertEqual(skeleton.edges[('h', 'i')]['matched_edge'] == ('C', ('X', 'C')))

        self.assertEqual(skeleton.edges[('b', 'd')]['matched_edge'], (('X', 'A'), ('X', 'D')))
        self.assertEqual(skeleton.edges[('d', 'e')]['matched_edge'], (('X', 'D'), ('X', 'B')))
        self.assertEqual(skeleton.edges[('e', 'f')]['matched_edge'], (('X', 'D'), ('X', 'B')))
        self.assertEqual(skeleton.edges[('f', 'h')]['matched_edge'], (('X', 'B'), ('X', 'C')))
